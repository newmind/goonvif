...
type OSDConfiguration struct {
	DeviceEntity                  `xml:"token,attr" json:"token"`
...
type OSDTextConfiguration struct {
	IsPersistentText xsd.Boolean `xml:"IsPersistentText,attr" json:"IsPersistentText"`
...
type OSDColor struct {
	Transparent int `xml:"Transparent,attr" json:"Transparent"`
...
type Color struct {
	...
	Colorspace xsd.AnyURI `swaggertype:"string" xml:"Colorspace,attr" json:"Colorspace"`
}

type OSDTextConfigurationExtension xsd.AnyType

type OSDImgConfiguration struct {
	ImgPath   xsd.AnyURI                   `swaggertype:"string" xml:"http://www.onvif.org/ver10/schema ImgPath"`
...
type Rectangle struct {
	Bottom float64 `xml:"bottom,attr" json:"bottom"`
	Top    float64 `xml:"top,attr" json:"top"`
	Right  float64 `xml:"right,attr" json:"right"`
	Left   float64 `xml:"left,attr" json:"left"`
}
...
type Profile struct {
	Token                       ReferenceToken `xml:"token,attr" json:"token"`
	Fixed                       bool           `xml:"fixed,attr" json:"fixed"`
	Name                        Name
...
type VideoSourceConfiguration struct {
	ConfigurationEntity
	ViewMode    string                            `xml:"ViewMode,attr" json:"ViewMode"`
...
type LensDescription struct {
	FocalLength float64        `xml:"FocalLength,attr" json:"FocalLength"`
...
type Config struct {
	...
	Type       xsd.QName `xml:"Type,attr" json:"Type"`
...
type PTZConfiguration struct {
	ConfigurationEntity
	MoveRamp                               int                       `xml:"MoveRamp,attr" json:"MoveRamp"`
	PresetRamp                             int                       `xml:"PresetRamp,attr" json:"PresetRamp"`
	PresetTourRamp                         int                       `xml:"PresetTourRamp,attr" json:"PresetTourRamp"`
	NodeToken                              ReferenceToken            `xml:"http://www.onvif.org/ver10/schema NodeToken"`
	DefaultAbsolutePantTiltPositionSpace   xsd.AnyURI                `swaggertype:"string" xml:"http://www.onvif.org/ver10/schema DefaultAbsolutePantTiltPositionSpace"`
	DefaultAbsoluteZoomPositionSpace       xsd.AnyURI                `swaggertype:"string" xml:"http://www.onvif.org/ver10/schema DefaultAbsoluteZoomPositionSpace"`
	DefaultRelativePanTiltTranslationSpace xsd.AnyURI                `swaggertype:"string" xml:"http://www.onvif.org/ver10/schema DefaultRelativePanTiltTranslationSpace"`
	DefaultRelativeZoomTranslationSpace    xsd.AnyURI                `swaggertype:"string" xml:"http://www.onvif.org/ver10/schema DefaultRelativeZoomTranslationSpace"`
	DefaultContinuousPanTiltVelocitySpace  xsd.AnyURI                `swaggertype:"string" xml:"http://www.onvif.org/ver10/schema DefaultContinuousPanTiltVelocitySpace"`
	DefaultContinuousZoomVelocitySpace     xsd.AnyURI                `swaggertype:"string" xml:"http://www.onvif.org/ver10/schema DefaultContinuousZoomVelocitySpace"`
...
type Vector2D struct {
	X     float64    `xml:"x,attr" json:"x"`
	Y     float64    `xml:"y,attr" json:"y"`
	Space xsd.AnyURI `swaggertype:"string" xml:"space,attr" json:"space"`
}
...
type Space2DDescription struct {
	URI    xsd.AnyURI `swaggertype:"string" xml:"http://www.onvif.org/ver10/schema URI"`
...
type MetadataConfiguration struct {
	ConfigurationEntity
	CompressionType              string                         `xml:"CompressionType,attr" json:"CompressionType"`
...
type AudioOutputConfiguration struct {
	...
	SendPrimacy xsd.AnyURI     `swaggertype:"string" xml:"http://www.onvif.org/ver10/schema SendPrimacy"`
...
type VideoSourceConfigurationOptions struct {
	MaximumNumberOfProfiles    int `xml:"MaximumNumberOfProfiles,attr" json:"MaximumNumberOfProfiles"`
...
type MaximumNumberOfOSDs struct {
	...
	PlainText   int `xml:"PlainText,attr" json:"PlainText"`
	Date        int `xml:"Date,attr" json:"Date"`
	Time        int `xml:"Time,attr" json:"Time"`
	DateAndTime int `xml:"DateAndTime,attr" json:"DateAndTime"`
}
...
type OSDImgOptions struct {
	FormatsSupported StringAttrList `xml:"FormatsSupported,attr" json:"FormatsSupported"`
	MaxSize          int            `xml:"MaxSize,attr" json:"MaxSize"`
	MaxWidth         int            `xml:"MaxWidth,attr" json:"MaxWidth"`
	MaxHeight        int            `xml:"MaxHeight,attr" json:"MaxHeight"`
...
type PTZNode struct {
	DeviceEntity
	FixedHomePosition      xsd.Boolean `xml:"FixedHomePosition,attr" json:"FixedHomePosition"`
	GeoMove                xsd.Boolean `xml:"GeoMove,attr" json:"GeoMove"`
	Name                   Name
...
type PTZConfigurationOptions struct {
	PTZRamps           IntAttrList `xml:"PTZRamps,attr" json:"PTZRamps"`
	Spaces             PTZSpaces
...
type PTZStatus struct {
	Position   PTZVector     `xml:"http://www.onvif.org/ver10/schema Position"`
	MoveStatus PTZMoveStatus `xml:"http://www.onvif.org/ver10/schema MoveStatus"`
	Error      string        `xml:"http://www.onvif.org/ver10/schema Error"`
	UtcTime    xsd.DateTime  `xml:"http://www.onvif.org/ver10/schema UtcTime"`
}
...
type MoveStatus string // IDLE, MOVING, UNKNOWN
type GeoLocation struct {
	Lon       xsd.Double `xml:"lon,attr" json:"lon"`
	Lat       xsd.Double `xml:"lat,attr" json:"lat"`
	Elevation xsd.Float  `xml:"elevation,attr" json:"elevation"`
}
...
type PTZPresetTourStartingCondition struct {
	RandomPresetOrder xsd.Boolean                             `xml:"RandomPresetOrder,attr" json:"RandomPresetOrder"`
...
type AttachmentData struct {
	ContentType ContentType `xml:"contentType,attr" json:"contentType"`
	Include     Include     `xml:"inc:Include"`
}

type Include struct {
	Href xsd.AnyURI `swaggertype:"string" xml:"href,attr" json:"href"`
}
...
type CertificateUsage struct {
	Critical         xsd.Boolean `xml:"Critical,attr" json:"Critical"`
...
type LocationEntity struct {
	Entity    xsd.String     `xml:"Entity,attr" json:"Entity"`
	Token     ReferenceToken `xml:"Token,attr" json:"Token"`
	Fixed     xsd.Boolean    `xml:"Fixed,attr" json:"Fixed"`
	GeoSource xsd.AnyURI     `swaggertype:"string" xml:"GeoSource,attr" json:"GeoSource"`
	AutoGeo   xsd.Boolean    `xml:"AutoGeo,attr" json:"AutoGeo"`
...
type LocalLocation struct {
	X xsd.Float `xml:"x,attr" json:"x"`
	Y xsd.Float `xml:"y,attr" json:"y"`
	Z xsd.Float `xml:"z,attr" json:"z"`
}

type GeoOrientation struct {
	Roll  xsd.Float `xml:"roll,attr" json:"roll"`
	Pitch xsd.Float `xml:"pitch,attr" json:"pitch"`
	Yaw   xsd.Float `xml:"yaw,attr" json:"yaw"`
}
